...
## Type: ShellCommand
## TODO make this work
c.editor.command = ['/opt/homebrew/bin/kitty', '-o', 'close_on_child_death=yes', 'nvim', '{file}'] #['vim', '{file}', '-c', 'normal {line}G{column0}l']
...
c.url.searchengines = { \
  ...
  'std': 'https://doc.rust-lang.org/stable/std/?search={}', \
}
